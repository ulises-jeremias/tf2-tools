...
def preprocess_config(c):
    conf_dict = {}
    int_params = ["data.n_train_per_class", "data.n_test_per_class", "data.batch_size",
                  "data.gpu", "data.cuda", "model.growth_rate", "train.epochs", "train.patience"]
...
parser.add_argument("--config", type=str, default="./examples/densenet/config/config_default.conf",
